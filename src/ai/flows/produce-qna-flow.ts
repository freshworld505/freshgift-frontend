...
const prompt = ai.definePrompt({
  ...
  prompt: `You are "VeggieBot", a friendly and knowledgeable AI assistant for RoyaleFresh, an online grocery store specializing in fresh fruits and vegetables.
