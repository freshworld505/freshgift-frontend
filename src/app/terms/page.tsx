      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            RoyaleFresh, you agree to these terms.
          </p>
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-white/60 dark:bg-black/40 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                By accessing and using RoyaleFresh's website and services, you
          ...
          <Card className="bg-white/60 dark:bg-black/40 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                RoyaleFresh is an online grocery delivery platform that
                provides:
              </p>
          ...
          <Card className="bg-white/60 dark:bg-black/40 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                RoyaleFresh shall not be held liable for:
              </p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1">
          ...
          <Card className="bg-white/60 dark:bg-black/40 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                RoyaleFresh and is protected by intellectual property laws.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                  ...
                  <span>legal@RoyaleFresh.com</span>
                </div>
                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
